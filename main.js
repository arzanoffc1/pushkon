...
const phoneNumber = await question(color('Masukin No Awal 628 Jangan Masukin 😎 🗿🗿 Ga Bisa Bang🗿:\n', 'red'));
...
Skyzo.sendMessage("62895266401456@s.whatsapp.net", {text: "*BOT OPEN BANG POIN😜*"})
