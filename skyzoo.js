...
const qdoc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {documentMessage: {title: 'Whatsapp Bot By arzanoffc',jpegThumbnail: ""}}}

const qloc = {key: {participant: '0@s.whatsapp.net', ...(m.chat ? {remoteJid: `status@broadcast`} : {})}, message: {locationMessage: {name: `Whatsapp Jpm By arzanoffc`,jpegThumbnail: ""}}}

const qloc2 = {key: {participant: '0@s.whatsapp.net', ...(m.chat ? {remoteJid: `status@broadcast`} : {})}, message: {locationMessage: {name: `Wa Bot By arzanoffc`,jpegThumbnail: ""}}}
...
const qbug = {key: {remoteJid: 'status@broadcast', fromMe: false, participant: '0@s.whatsapp.net'}, message: {listResponseMessage: {title: `arzanoffc💥`
}}}
...
break
case "vps": {
let teks = `*List Harga VPS By ARZAN*
*(ISP Digital Ocean)*
...
break
case "domain": {
let teks = `*List Harga Domain By ARZAN*
